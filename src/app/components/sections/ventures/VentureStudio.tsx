...
const VentureStudio = () => {
    return (
        <div className='flex flex-col px-[15px] w-full lg:w-[90%] items-center xl:w-[1390px] mx-auto lg:flex-row gap-6 lg:gap-[96px] py-[60px] lg:py-[160px]'>
            ...
            <div className='order-1 lg:order-2 flex flex-col gap-4 lg:gap-6 items-center lg:items-start text-center lg:text-left w-full lg:w-[500px] xl:w-[600px] 2xl:w-[630px]'>
