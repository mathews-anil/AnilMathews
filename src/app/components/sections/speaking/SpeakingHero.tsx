  ...
  return (
    <div className='mt-[15px] lg:mt-[41px] mb-[64px] lg:mb-[120px] px-4 lg:px-[50px] xl:px-[80px] 2xl:px-[163px] mx-auto max-w-[1920px]'>
      <div className='relative w-full flex flex-col justify-start '>
        <h2 className='w-[200px] absolute bottom-[15px] left-[15px] lg:top-[50px] xl:top-[60px] 2xl:top-[110px] lg:left-[70px] xl:left-[110px] 2xl:left-[160px] lg:w-[350px] 2xl:w-[450px] z-50 font-charter leading-[24px] lg:leading-[64px] text-[24px] lg:text-[45px] 2xl:text-[64px] text-[#111111]' style={{ letterSpacing: "-2px" }}>I speak about execution, not theory.</h2>
        <p className='text-[#111111] absolute bottom-0 xl:bottom-[30px] 2xl:bottom-[15px] para_custom_bottom hidden lg:block w-full lg:w-[600px] xl:w-[800px] 2xl:w-[750px] z-50 opacity-65 font-inter text-base lg:text-[17px] '>Every talk comes from firsthand experience: building products, leading teams across continents,
