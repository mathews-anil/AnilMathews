  ...
  return (
    <div className='mt-[15px] lg:mt-[41px] mb-[64px] lg:mb-[120px] px-4 lg:px-[50px] xl:px-[80px] 2xl:px-[163px] mx-auto max-w-[1920px]'>
      <div className='relative w-full flex flex-col justify-start '>
        ...
        <p className='text-[#111111] absolute bottom-0 xl:bottom-[30px] 2xl:bottom-[15px] para_custom_bottom hidden lg:block w-full lg:w-[600px] xl:w-[800px] 2xl:w-[750px] z-30 opacity-65 font-inter text-base lg:text-[17px] '>Every talk comes from firsthand experience: building products, leading teams across continents,
